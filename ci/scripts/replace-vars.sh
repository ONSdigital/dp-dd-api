...
sed dp-dd-database-loader/appspec.yml dp-dd-database-loader/scripts/codedeploy/* -i \
...
cp dp-dd-database-loader/appspec.yml artifacts/
cp dp-dd-database-loader/scripts/codedeploy/* artifacts/scripts/codedeploy
